...
export default function NotFound() {
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center  bg-[#F8F8F8] text-center px-4">
      ...
      <div className="flex gap-4 mt-6">
        <Link href="/" className="btn btn-primary flex items-center gap-2 text-white" >
          <IoHome />  Home
        </Link>
